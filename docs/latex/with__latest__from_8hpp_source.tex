...
\DoxyCodeLine{52 \textcolor{keyword}{struct }with\_latest\_from\_state\_t}
\DoxyCodeLine{53 \{}
...
\DoxyCodeLine{76     \{}
\DoxyCodeLine{77         \textcolor{keyword}{auto} state = std::make\_shared<with\_latest\_from\_state\_t<TObservables...>>();}
\DoxyCodeLine{78 }
