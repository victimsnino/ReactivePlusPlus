...
\DoxyCodeLine{48 \{}
\DoxyCodeLine{49     \textcolor{keywordtype}{void} operator()(\textcolor{keyword}{auto}\&\& value, \textcolor{keyword}{const} constraint::subscriber \textcolor{keyword}{auto}\&, \textcolor{keyword}{const} \textcolor{keyword}{auto}\& state)\textcolor{keyword}{ const}}
...
\DoxyCodeLine{115 \};}
\DoxyCodeLine{116 }
\DoxyCodeLine{117 \textcolor{keyword}{template}<constraint::decayed\_type Type, \textcolor{keyword}{typename} TSelector, constraint::observable ...TObservables>}
