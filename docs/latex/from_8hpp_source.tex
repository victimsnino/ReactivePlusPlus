...
\DoxyCodeLine{197 \{}
\DoxyCodeLine{198     \textcolor{keywordflow}{return} just<memory\_model>(schedulers::immediate\{\}, std::forward<T>(item), std::forward<Ts>(items)...);}
\DoxyCodeLine{199 \}}
\DoxyCodeLine{200 }
\DoxyCodeLine{221 \textcolor{keyword}{template}<memory\_model memory\_model \textcolor{comment}{/* = memory\_model::use\_stack */}, schedulers::constraint::scheduler TScheduler \textcolor{comment}{/* = schedulers::immediate */}>}
