...
{\footnotesize template$<$schedulers\+::constraint\+::scheduler TScheduler$>$ \newline
requires is\+\_\+header\+\_\+included$<$subscribe\+\_\+on\+\_\+tag, TScheduler$>$}\\auto \mbox{\hyperlink{group__operators_ga2272435c76e0830c70e111b3270cd3d4}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, subscribe\+\_\+on\+\_\+tag $>$\+::subscribe\+\_\+on}} (const TScheduler \&scheduler) const \&
...
requires is\+\_\+header\+\_\+included$<$with\+\_\+latest\+\_\+from\+\_\+tag, TObservables...$>$}\\auto \mbox{\hyperlink{group__operators_ga805656c8847d81ace55ebc71d0598e44}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, with\+\_\+latest\+\_\+from\+\_\+tag $>$\+::with\+\_\+latest\+\_\+from}} (TSelector \&\&selector, TObservables \&\&...observables) const \&
\begin{DoxyCompactList}\small\item\em combines latest emissions from multiple observables, but sends to observer only when root observable sends values \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\#include \texorpdfstring{$<$}{<}rpp/operators/repeat.\+h\texorpdfstring{$>$}{>} 
\end{DoxyWarning}
\mbox{\Hypertarget{group__operators_ga2272435c76e0830c70e111b3270cd3d4}\label{group__operators_ga2272435c76e0830c70e111b3270cd3d4}} 
\index{Operators@{Operators}!subscribe\_on@{subscribe\_on}}
\index{subscribe\_on@{subscribe\_on}!Operators@{Operators}}
...
forces observable to operate in provided scheduler (on\+\_\+subscribe called via scheduling) 
...
\DoxyCodeLine{            \})}
\DoxyCodeLine{            .\mbox{\hyperlink{group__operators_ga2272435c76e0830c70e111b3270cd3d4}{subscribe\_on}}(\mbox{\hyperlink{classrpp_1_1schedulers_1_1new__thread}{rpp::schedulers::new\_thread}}\{\})}
\DoxyCodeLine{            .as\_blocking()}
\DoxyCodeLine{            .subscribe([](\textcolor{keywordtype}{int} v) \{ std::cout << \textcolor{stringliteral}{"{}["{}} << std::this\_thread::get\_id() << \textcolor{stringliteral}{"{}] : "{}} << v << \textcolor{stringliteral}{"{}\(\backslash\)n"{}}; \});}
\DoxyCodeLine{    \textcolor{comment}{// Template for output:}}
\DoxyCodeLine{    \textcolor{comment}{// TH1}}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}rpp/operators/subscribe\+\_\+on.\+h\texorpdfstring{$>$}{>} 
\end{DoxyWarning}
...
\end{DoxyWarning}
\mbox{\Hypertarget{group__operators_ga805656c8847d81ace55ebc71d0598e44}\label{group__operators_ga805656c8847d81ace55ebc71d0598e44}} 
\index{Operators@{Operators}!with\_latest\_from@{with\_latest\_from}}
\index{with\_latest\_from@{with\_latest\_from}!Operators@{Operators}}
\doxysubsubsection{\texorpdfstring{with\_latest\_from()}{with\_latest\_from()}}
{\footnotesize\ttfamily template$<$constraint\+::decayed\+\_\+type Type, typename Specific\+Observable $>$ \\
...
combines latest emissions from multiple observables, but sends to observer only when root observable sends values 

when observables from arguments send some value, then these values cached/replaced, but when root observable sends value, then this value aggregated together with cached by default selector creates tuple of values


\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    \mbox{\hyperlink{group__observables_ga819797b9fb7452311dedc62aa94d1f7b}{rpp::source::just}}(1, 2, 3).with\_latest\_from(\mbox{\hyperlink{group__observables_ga819797b9fb7452311dedc62aa94d1f7b}{rpp::source::just}}(3, 4, 5, 6))}
...
\begin{DoxyCodeInclude}{0}
\DoxyCodeLine{    \mbox{\hyperlink{group__observables_ga819797b9fb7452311dedc62aa94d1f7b}{rpp::source::just}}(1, 2, 3).with\_latest\_from([](\textcolor{keywordtype}{int} left, \textcolor{keywordtype}{int} right) \{ \textcolor{keywordflow}{return} left + right; \},}
\DoxyCodeLine{                                                \mbox{\hyperlink{group__observables_ga819797b9fb7452311dedc62aa94d1f7b}{rpp::source::just}}(3, 4, 5, 6))}
\DoxyCodeLine{                              .subscribe([](\textcolor{keywordtype}{int} v)}
\DoxyCodeLine{                              \{}
\DoxyCodeLine{                                  std::cout << v << \textcolor{stringliteral}{"{} "{}};}
\DoxyCodeLine{                              \});}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}rpp/operators/with\+\_\+latest\+\_\+from.\+h\texorpdfstring{$>$}{>} 
\end{DoxyWarning}
