...
\DoxyCodeLine{47 }
\DoxyCodeLine{48     \mbox{\hyperlink{classrpp_1_1specific__observer}{specific\_observer}}(constraint::on\_next\_fn<T> \textcolor{keyword}{auto}\&\& \mbox{\hyperlink{classrpp_1_1details_1_1state__observer_a3d2a9f268664b6281c43faa6200fbc04}{on\_next}}, constraint::on\_completed\_fn \textcolor{keyword}{auto}\&\& \mbox{\hyperlink{classrpp_1_1details_1_1state__observer_a446a677206acc784454ceadae9f61e4d}{on\_completed}})}
...
\DoxyCodeLine{81 \textcolor{keyword}{auto} make\_specific\_observer(constraint::on\_next\_fn<Type> \textcolor{keyword}{auto}\&\& on\_next) -\/> specific\_observer\_with\_decayed\_args<Type, \textcolor{keyword}{decltype}(on\_next)>}
\DoxyCodeLine{82 \{}
\DoxyCodeLine{83     \textcolor{keywordflow}{return} \{std::forward<decltype(on\_next)>(on\_next)\};}
\DoxyCodeLine{84 \}}
\DoxyCodeLine{85 }
\DoxyCodeLine{86 \textcolor{keyword}{template}<constra\textcolor{keywordtype}{int}::decayed\_type Type>}
\DoxyCodeLine{87 \textcolor{keyword}{auto} make\_specific\_observer(constraint::on\_next\_fn<Type> \textcolor{keyword}{auto}\&\& on\_next,}
\DoxyCodeLine{88                             constraint::on\_completed\_fn \textcolor{keyword}{auto}\&\&  on\_completed) -\/> specific\_observer\_with\_decayed\_args<Type, \textcolor{keyword}{decltype}(on\_next), utils::rethrow\_error\_t, \textcolor{keyword}{decltype}(on\_completed)>}
\DoxyCodeLine{89 \{}
\DoxyCodeLine{90     \textcolor{keywordflow}{return} \{std::forward<decltype(on\_next)>(on\_next), std::forward<decltype(on\_completed)>(on\_completed)\};}
\DoxyCodeLine{91 \}}
\DoxyCodeLine{92 }
\DoxyCodeLine{93 \textcolor{keyword}{template}<constra\textcolor{keywordtype}{int}::decayed\_type Type>}
\DoxyCodeLine{94 \textcolor{keyword}{auto} make\_specific\_observer(constraint::on\_next\_fn<Type> \textcolor{keyword}{auto}\&\& on\_next,}
\DoxyCodeLine{95                             constraint::on\_error\_fn \textcolor{keyword}{auto}\&\&      on\_error) -\/> specific\_observer\_with\_decayed\_args<Type, \textcolor{keyword}{decltype}(on\_next), \textcolor{keyword}{decltype}(on\_error)>}
\DoxyCodeLine{96 \{}
\DoxyCodeLine{97     \textcolor{keywordflow}{return} \{std::forward<decltype(on\_next)>(on\_next), std::forward<decltype(on\_error)>(on\_error)\};}
\DoxyCodeLine{98 \}}
\DoxyCodeLine{99 }
\DoxyCodeLine{100 \textcolor{keyword}{template}<constra\textcolor{keywordtype}{int}::decayed\_type Type>}
\DoxyCodeLine{101 \textcolor{keyword}{auto} make\_specific\_observer(constraint::on\_next\_fn<Type> \textcolor{keyword}{auto}\&\& on\_next,}
\DoxyCodeLine{102                             constraint::on\_error\_fn \textcolor{keyword}{auto}\&\&      on\_error,}
\DoxyCodeLine{103                             constraint::on\_completed\_fn \textcolor{keyword}{auto}\&\&  on\_completed) -\/> specific\_observer\_with\_decayed\_args<Type, \textcolor{keyword}{decltype}(on\_next), \textcolor{keyword}{decltype}(on\_error), \textcolor{keyword}{decltype}(on\_completed)>}
\DoxyCodeLine{104 \{}
\DoxyCodeLine{105     \textcolor{keywordflow}{return} \{std::forward<decltype(on\_next)>(on\_next),}
\DoxyCodeLine{106             std::forward<decltype(on\_error)>(on\_error),}
\DoxyCodeLine{107             std::forward<decltype(on\_completed)>(on\_completed)\};}
\DoxyCodeLine{108 \}}
\DoxyCodeLine{109 }
\DoxyCodeLine{110 }
\DoxyCodeLine{111 \textcolor{keyword}{namespace }details}
\DoxyCodeLine{112 \{}
\DoxyCodeLine{113     \textcolor{keyword}{template}<constraint::decayed\_type Type, \textcolor{keyword}{typename} ...Args>}
\DoxyCodeLine{114     \textcolor{keyword}{using }deduce\_specific\_observer\_type\_t = \textcolor{keyword}{decltype}(make\_specific\_observer<Type>(std::declval<Args>()...));}
\DoxyCodeLine{115 \} \textcolor{comment}{// namespace details}}
