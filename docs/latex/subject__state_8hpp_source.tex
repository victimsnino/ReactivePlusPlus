...
\DoxyCodeLine{22 \{}
\DoxyCodeLine{23 \textcolor{keyword}{template}<rpp::constra\textcolor{keywordtype}{int}::decayed\_type T>}
...
\DoxyCodeLine{37 \};}
\DoxyCodeLine{38 }
\DoxyCodeLine{39 \textcolor{keyword}{template}<rpp::constra\textcolor{keywordtype}{int}::decayed\_type T>}
...
\DoxyCodeLine{54 \};}
\DoxyCodeLine{55 }
\DoxyCodeLine{56 \textcolor{keyword}{template}<rpp::constra\textcolor{keywordtype}{int}::decayed\_type T>}
...
\DoxyCodeLine{70 \};}
\DoxyCodeLine{71 }
\DoxyCodeLine{72 \textcolor{keyword}{template}<rpp::constra\textcolor{keywordtype}{int}::decayed\_type T>}
...
\DoxyCodeLine{86 \};}
\DoxyCodeLine{87 }
\DoxyCodeLine{88 \textcolor{keyword}{template}<rpp::constra\textcolor{keywordtype}{int}::decayed\_type T>}
...
\DoxyCodeLine{147 \{}
\DoxyCodeLine{148 \textcolor{keyword}{template}<rpp::constra\textcolor{keywordtype}{int}::decayed\_type T>}
...
\DoxyCodeLine{168                 \mbox{\hyperlink{classrpp_1_1dynamic__subscriber}{subscriber}}.get\_subscription().\mbox{\hyperlink{classrpp_1_1composite__subscription_a7ea8553bdf67bbceab87dd14b7c42e3c}{add}}([weak]}
\DoxyCodeLine{169                 \{}
...
\DoxyCodeLine{233     rpp::utils::atomic\_shared\_ptr<const states::state\_interface<T>> m\_state = std::make\_shared<states::active<T>>();}
\DoxyCodeLine{234 \};}
