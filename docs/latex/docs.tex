...
\hypertarget{quick_start_autotoc_md20}{}\doxysubsection{Brief workflow}\label{quick_start_autotoc_md20}
For the brief overview of the Reactive pattern read \href{https://reactivex.io/}{\texttt{ https\+://reactivex.\+io/}}.

In short, creation of programs with help of Reactive\+Plus\+Plus split into several parts\+:\hypertarget{quick_start_autotoc_md21}{}\doxysubsubsection{1) Define observables}\label{quick_start_autotoc_md21}
...
Action inside observable happens O\+N\+LY after subscription on this observable and O\+N\+LY for provided subscriber/observer. It means, that you can subscribe on the same observable multiple times!\hypertarget{quick_start_autotoc_md22}{}\doxysubsubsection{2) Chain observable}\label{quick_start_autotoc_md22}
...
\DoxyCodeLine{.map(\&::toupper)}
\end{DoxyCode}
\hypertarget{quick_start_autotoc_md23}{}\doxysubsubsection{3) Subscription}\label{quick_start_autotoc_md23}
...
\hypertarget{specific_vs_dynamic_autotoc_md24}{}\doxysubsection{Brief overview}\label{specific_vs_dynamic_autotoc_md24}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{specific_vs_dynamic_autotoc_md25}{}\doxysubsection{Reactive\+Plus\+Plus solution}\label{specific_vs_dynamic_autotoc_md25}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{specific_vs_dynamic_autotoc_md26}{}\doxysubsection{Examples}\label{specific_vs_dynamic_autotoc_md26}
...
\hypertarget{memory_model_autotoc_md18}{}\doxysubsection{Overview}\label{memory_model_autotoc_md18}
...
So, R\+PP provides ability to select strategy \char`\"{}how to deal with such a variables\char`\"{} via {\ttfamily rpp\+::memory\+\_\+model} enum.\hypertarget{memory_model_autotoc_md19}{}\doxysubsection{Examples}\label{memory_model_autotoc_md19}
...
\item \mbox{[} \mbox{]} zip
\end{DoxyItemize}\hypertarget{status_autotoc_md12}{}\doxysubsubsection{Aggregate}\label{status_autotoc_md12}
...
\item \mbox{[} \mbox{]} sum
\end{DoxyItemize}\hypertarget{status_autotoc_md13}{}\doxysubsubsection{Backpressure}\label{status_autotoc_md13}

\begin{DoxyItemize}
\item \mbox{[} \mbox{]} backpressure ???
\end{DoxyItemize}\hypertarget{status_autotoc_md14}{}\doxysubsubsection{Error handling}\label{status_autotoc_md14}

\begin{DoxyItemize}
\item \mbox{[} \mbox{]} catch
\item \mbox{[} \mbox{]} retry
\end{DoxyItemize}\hypertarget{status_autotoc_md15}{}\doxysubsubsection{Utility}\label{status_autotoc_md15}

\begin{DoxyItemize}
\item \mbox{[}x\mbox{]} observe\+\_\+on
\item \mbox{[}x\mbox{]} repeat
\begin{DoxyItemize}
\item \mbox{[} \mbox{]} scheduling (by default current\+\_\+thread ?)
\end{DoxyItemize}
...
\item \mbox{[} \mbox{]} 
\end{DoxyItemize}\hypertarget{status_autotoc_md16}{}\doxysubsubsection{Connectable}\label{status_autotoc_md16}
...
\end{DoxyItemize}\hypertarget{status_autotoc_md17}{}\doxysubsection{Subjects}\label{status_autotoc_md17}
