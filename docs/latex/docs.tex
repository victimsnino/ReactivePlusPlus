...
\hypertarget{quick_start_autotoc_md23}{}\doxysubsection{Brief workflow}\label{quick_start_autotoc_md23}
For the brief overview of the Reactive pattern read \href{https://reactivex.io/}{\texttt{ https\+://reactivex.\+io/}}.

In short, creation of programs with help of Reactive\+Plus\+Plus split into several parts\+:\hypertarget{quick_start_autotoc_md24}{}\doxysubsubsection{1) Define observables}\label{quick_start_autotoc_md24}
...
\DoxyCodeLine{.map(\&::toupper)}
\end{DoxyCode}
\hypertarget{quick_start_autotoc_md26}{}\doxysubsubsection{3) Subscription}\label{quick_start_autotoc_md26}
...
\hypertarget{specific_vs_dynamic_autotoc_md27}{}\doxysubsection{Brief overview}\label{specific_vs_dynamic_autotoc_md27}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{specific_vs_dynamic_autotoc_md28}{}\doxysubsection{Reactive\+Plus\+Plus solution}\label{specific_vs_dynamic_autotoc_md28}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{specific_vs_dynamic_autotoc_md29}{}\doxysubsection{Examples}\label{specific_vs_dynamic_autotoc_md29}
...
\hypertarget{memory_model_autotoc_md21}{}\doxysubsection{Overview}\label{memory_model_autotoc_md21}
...
So, R\+PP provides ability to select strategy \char`\"{}how to deal with such a variables\char`\"{} via {\ttfamily rpp\+::memory\+\_\+model} enum.\hypertarget{memory_model_autotoc_md22}{}\doxysubsection{Examples}\label{memory_model_autotoc_md22}
...
\hypertarget{status_autotoc_md7}{}\doxysubsection{Foundamentals}\label{status_autotoc_md7}
...
\end{DoxyItemize}\hypertarget{status_autotoc_md20}{}\doxysubsection{T\+O\+D\+O\+:}\label{status_autotoc_md20}

\begin{DoxyItemize}
\item \mbox{[} \mbox{]} Add valid spinlock and use it in appropriate places to boost performance
\item \mbox{[} \mbox{]} Add delay as feature request
\item \mbox{[} \mbox{]} Add sample as feature request
\item \mbox{[} \mbox{]} Polish take\+\_\+until
\item \mbox{[} \mbox{]} Polish earyly unsubscribe (check for unsubscription) 
\end{DoxyItemize}