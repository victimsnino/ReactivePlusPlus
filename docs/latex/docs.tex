...
\hypertarget{quick_start_autotoc_md21}{}\doxysubsection{Brief workflow}\label{quick_start_autotoc_md21}
For the brief overview of the Reactive pattern read \href{https://reactivex.io/}{\texttt{ https\+://reactivex.\+io/}}.

In short, creation of programs with help of Reactive\+Plus\+Plus split into several parts\+:\hypertarget{quick_start_autotoc_md22}{}\doxysubsubsection{1) Define observables}\label{quick_start_autotoc_md22}
...
Action inside observable happens O\+N\+LY after subscription on this observable and O\+N\+LY for provided subscriber/observer. It means, that you can subscribe on the same observable multiple times!\hypertarget{quick_start_autotoc_md23}{}\doxysubsubsection{2) Chain observable}\label{quick_start_autotoc_md23}
...
\DoxyCodeLine{.map(\&::toupper)}
\end{DoxyCode}
\hypertarget{quick_start_autotoc_md24}{}\doxysubsubsection{3) Subscription}\label{quick_start_autotoc_md24}
...
\hypertarget{specific_vs_dynamic_autotoc_md25}{}\doxysubsection{Brief overview}\label{specific_vs_dynamic_autotoc_md25}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{specific_vs_dynamic_autotoc_md26}{}\doxysubsection{Reactive\+Plus\+Plus solution}\label{specific_vs_dynamic_autotoc_md26}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{specific_vs_dynamic_autotoc_md27}{}\doxysubsection{Examples}\label{specific_vs_dynamic_autotoc_md27}
...
\hypertarget{memory_model_autotoc_md19}{}\doxysubsection{Overview}\label{memory_model_autotoc_md19}
...
So, R\+PP provides ability to select strategy \char`\"{}how to deal with such a variables\char`\"{} via {\ttfamily rpp\+::memory\+\_\+model} enum.\hypertarget{memory_model_autotoc_md20}{}\doxysubsection{Examples}\label{memory_model_autotoc_md20}
...
\hypertarget{status_autotoc_md6}{}\doxysubsection{Foundamentals}\label{status_autotoc_md6}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{status_autotoc_md7}{}\doxysubsection{Creating Observables}\label{status_autotoc_md7}
...
\end{DoxyItemize}\hypertarget{status_autotoc_md8}{}\doxysubsection{Operators}\label{status_autotoc_md8}
\hypertarget{status_autotoc_md9}{}\doxysubsubsection{Transforming}\label{status_autotoc_md9}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{status_autotoc_md10}{}\doxysubsubsection{Filtering}\label{status_autotoc_md10}
...
\end{DoxyItemize}\hypertarget{status_autotoc_md11}{}\doxysubsubsection{Conditional}\label{status_autotoc_md11}
...
\end{DoxyItemize}\hypertarget{status_autotoc_md12}{}\doxysubsubsection{Combining}\label{status_autotoc_md12}
...
\item \mbox{[} \mbox{]} zip
\end{DoxyItemize}\hypertarget{status_autotoc_md13}{}\doxysubsubsection{Aggregate}\label{status_autotoc_md13}
...
\item \mbox{[} \mbox{]} sum
\end{DoxyItemize}\hypertarget{status_autotoc_md14}{}\doxysubsubsection{Backpressure}\label{status_autotoc_md14}

\begin{DoxyItemize}
\item \mbox{[} \mbox{]} backpressure ???
\end{DoxyItemize}\hypertarget{status_autotoc_md15}{}\doxysubsubsection{Error handling}\label{status_autotoc_md15}

\begin{DoxyItemize}
\item \mbox{[} \mbox{]} catch
\item \mbox{[} \mbox{]} retry
\end{DoxyItemize}\hypertarget{status_autotoc_md16}{}\doxysubsubsection{Utility}\label{status_autotoc_md16}
...
\item \mbox{[} \mbox{]} 
\end{DoxyItemize}\hypertarget{status_autotoc_md17}{}\doxysubsubsection{Connectable}\label{status_autotoc_md17}
...
\end{DoxyItemize}\hypertarget{status_autotoc_md18}{}\doxysubsection{Subjects}\label{status_autotoc_md18}
