...
requires is\+\_\+header\+\_\+included$<$reduce\+\_\+tag, Seed, Accumulator\+Fn, Result\+Selector\+Fn$>$}\\auto \mbox{\hyperlink{group__transforming__operators_gadbd7324870bd396f776cba8a75880ce0}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, reduce\+\_\+tag $>$\+::reduce}} (Seed \&\&initial\+\_\+seed, Accumulator\+Fn \&\&accumulator, Result\+Selector\+Fn \&\&result\+\_\+selector=\{\}) const \&
...
requires (is\+\_\+header\+\_\+included$<$reduce\+\_\+tag, Cast\+Before\+Divide, Args...$>$ \&\& is\+\_\+can\+\_\+be\+\_\+averaged$<$Type, Cast\+Before\+Divide$>$)}\\auto \mbox{\hyperlink{group__transforming__operators_gac6c86c5f3ebafdf93a7abb156909330b}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, reduce\+\_\+tag $>$\+::average}} () const \&
\begin{DoxyCompactList}\small\item\em Calculates the average of emissions and emits final value. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename ... Args$>$ \newline
requires (is\+\_\+header\+\_\+included$<$reduce\+\_\+tag, Args...$>$ \&\& is\+\_\+can\+\_\+be\+\_\+summed$<$Type$>$)}\\auto \mbox{\hyperlink{group__transforming__operators_ga3f6b3475cee0f75abcf379e1428d4069}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, reduce\+\_\+tag $>$\+::sum}} () const \&
\begin{DoxyCompactList}\small\item\em Calculates the sum of emissions and emits final value. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename ... Args$>$ \newline
requires is\+\_\+header\+\_\+included$<$reduce\+\_\+tag, Args...$>$}\\auto \mbox{\hyperlink{group__transforming__operators_gadd81455e5ca0880aed07bf2312e19928}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, reduce\+\_\+tag $>$\+::count}} () const \&
...
requires is\+\_\+header\+\_\+included$<$reduce\+\_\+tag, Comparator, Args...$>$}\\auto \mbox{\hyperlink{group__transforming__operators_gad9dd23a7777f085a803b4185c798536a}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, reduce\+\_\+tag $>$\+::min}} (Comparator \&\&comparator=\{\}) const \&
...
{\footnotesize template$<$std\+::strict\+\_\+weak\+\_\+order$<$ Type, Type $>$ Comparator = std\+::less$<$\+Type$>$, typename ... Args$>$ \newline
requires is\+\_\+header\+\_\+included$<$reduce\+\_\+tag, Comparator, Args...$>$}\\auto \mbox{\hyperlink{group__transforming__operators_ga97dbe4031ca14517822a303b5a00f3e8}{rpp\+::details\+::member\+\_\+overload$<$ Type, Specific\+Observable, reduce\+\_\+tag $>$\+::max}} (Comparator \&\&comparator=\{\}) const \&
...
\mbox{\Hypertarget{group__transforming__operators_gac6c86c5f3ebafdf93a7abb156909330b}\label{group__transforming__operators_gac6c86c5f3ebafdf93a7abb156909330b}} 
\index{Transforming Operators@{Transforming Operators}!average@{average}}
\index{average@{average}!Transforming Operators@{Transforming Operators}}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}\mbox{\hyperlink{buffer_8hpp_source}{rpp/operators/buffer.\+hpp}}\texorpdfstring{$>$}{>}
\end{DoxyWarning}
\begin{DoxyParagraph}{Example\+:}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{group__transforming__operators_gadd81455e5ca0880aed07bf2312e19928}\label{group__transforming__operators_gadd81455e5ca0880aed07bf2312e19928}} 
\index{Transforming Operators@{Transforming Operators}!count@{count}}
\index{count@{count}!Transforming Operators@{Transforming Operators}}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}\mbox{\hyperlink{flat__map_8hpp_source}{rpp/operators/flat\+\_\+map.\+hpp}}\texorpdfstring{$>$}{>}
\end{DoxyWarning}
\begin{DoxyParagraph}{Example\+:}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}\mbox{\hyperlink{group__by_8hpp_source}{rpp/operators/group\+\_\+by.\+hpp}}\texorpdfstring{$>$}{>}
\end{DoxyWarning}
\begin{DoxyParagraph}{Example\+:}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{group__transforming__operators_ga97dbe4031ca14517822a303b5a00f3e8}\label{group__transforming__operators_ga97dbe4031ca14517822a303b5a00f3e8}} 
\index{Transforming Operators@{Transforming Operators}!max@{max}}
\index{max@{max}!Transforming Operators@{Transforming Operators}}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{group__transforming__operators_gad9dd23a7777f085a803b4185c798536a}\label{group__transforming__operators_gad9dd23a7777f085a803b4185c798536a}} 
\index{Transforming Operators@{Transforming Operators}!min@{min}}
\index{min@{min}!Transforming Operators@{Transforming Operators}}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{group__transforming__operators_gadbd7324870bd396f776cba8a75880ce0}\label{group__transforming__operators_gadbd7324870bd396f776cba8a75880ce0}} 
\index{Transforming Operators@{Transforming Operators}!reduce@{reduce}}
\index{reduce@{reduce}!Transforming Operators@{Transforming Operators}}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}\mbox{\hyperlink{scan_8hpp_source}{rpp/operators/scan.\+hpp}}\texorpdfstring{$>$}{>}
\end{DoxyWarning}
\begin{DoxyParagraph}{Example}
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{group__transforming__operators_ga3f6b3475cee0f75abcf379e1428d4069}\label{group__transforming__operators_ga3f6b3475cee0f75abcf379e1428d4069}} 
\index{Transforming Operators@{Transforming Operators}!sum@{sum}}
\index{sum@{sum}!Transforming Operators@{Transforming Operators}}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}\mbox{\hyperlink{switch__map_8hpp_source}{rpp/operators/switch\+\_\+map.\+hpp}}\texorpdfstring{$>$}{>}
\end{DoxyWarning}
\begin{DoxyParagraph}{Example\+:}
...
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
\#include \texorpdfstring{$<$}{<}\mbox{\hyperlink{window_8hpp_source}{rpp/operators/window.\+hpp}}\texorpdfstring{$>$}{>}
\end{DoxyWarning}
\begin{DoxyParagraph}{Example}
