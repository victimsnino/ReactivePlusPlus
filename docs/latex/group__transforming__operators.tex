...
Actually this operator applies {\ttfamily key\+\_\+selector} to emission to obtain key, place \mbox{\hyperlink{classrpp_1_1grouped__observable}{rpp\+::grouped\+\_\+observable}} to map with corresponding map and then send observable with this key (if not yet). Original values emitted via this grouped\+\_\+observables
...
\item Emit value via \mbox{\hyperlink{classrpp_1_1grouped__observable}{grouped\+\_\+observable}} from map for corresponding key
\end{DoxyItemize}
\item {\bfseries{On\+Error}}
\begin{DoxyItemize}
