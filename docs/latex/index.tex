...
\DoxyCodeLine{\});}
\DoxyCodeLine{}
\DoxyCodeLine{observable.\mbox{\hyperlink{classrpp_1_1dynamic__observable_a58b8ab8917cc6d757b95d71d4293d1ec}{subscribe}}(\mbox{\hyperlink{classrpp_1_1specific__observer}{rpp::specific\_observer}}\{[](\textcolor{keywordtype}{int} v)\{ std::cout << v;\}\});}
\DoxyCodeLine{}
...
\DoxyCodeLine{\});}
\DoxyCodeLine{}
\DoxyCodeLine{observable.\mbox{\hyperlink{classrpp_1_1dynamic__observable_a58b8ab8917cc6d757b95d71d4293d1ec}{subscribe}}(\mbox{\hyperlink{classrpp_1_1dynamic__observer}{rpp::dynamic\_observer}}\{[](\textcolor{keywordtype}{int} v)\{ std::cout << v;\}\});}
