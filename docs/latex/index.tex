...
So, to achieve best performance avoid usage of {\ttfamily dynamic\+\_\+} specialization till you really need it. For example, 
\begin{DoxyCode}{0}
...
For detailed comparison of performance of different operations for {\ttfamily specific\+\_\+} and {\ttfamily dynamic\+\_\+} you can find in \href{https://victimsnino.github.io/ReactivePlusPlus/benchmark}{\texttt{ Continous Performance}} 