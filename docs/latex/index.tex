...
\end{DoxyItemize}\hypertarget{index_autotoc_md3}{}\doxysection{Sample}\label{index_autotoc_md3}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{auto} observable = rpp::source::create<char>([](\textcolor{keyword}{const} \textcolor{keyword}{auto}\& sub)}
\DoxyCodeLine{                \{}
...
\DoxyCodeLine{}
\DoxyCodeLine{observable.subscribe([](\textcolor{keywordtype}{char} v)}
\DoxyCodeLine{\{}
\DoxyCodeLine{  std::cout << v;}
\DoxyCodeLine{\});}
