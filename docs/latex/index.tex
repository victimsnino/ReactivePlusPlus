...
\begin{DoxyCode}{0}
\DoxyCodeLine{observable.create}

\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxysection{Implementation Status}\label{index_autotoc_md4}
Current implementation status of different operators and future plans can be found docs/\+Implementation\%20\+Status.\+md \char`\"{}there\char`\"{}\hypertarget{index_autotoc_md5}{}\doxysection{Documentation}\label{index_autotoc_md5}
...
Manual documentation can be found in docs folder.\hypertarget{index_autotoc_md6}{}\doxysection{Performance}\label{index_autotoc_md6}
...
This repository uses continous benchmarking\+: every commit and pull request measured and diff per each benchmark provided. Graphs over benchmark results can be found \href{https://victimsnino.github.io/ReactivePlusPlus/benchmark}{\texttt{ here}}\hypertarget{index_autotoc_md7}{}\doxysection{Credits\+:}\label{index_autotoc_md7}
...
\item \href{reactivex.io}{\texttt{ reactivex.\+io}} as source for insipration and definition of entities used in RPP. Some comments used in RPP source code taken from \href{reactivex.io}{\texttt{ reactivex.\+io}} 
\end{DoxyItemize}