...
\end{DoxyItemize}\hypertarget{index_autotoc_md3}{}\doxysection{Implementation Status}\label{index_autotoc_md3}
Current implementation status of different operators and future plans can be found docs/\+Implementation\%20\+Status.\+md \char`\"{}there\char`\"{}\hypertarget{index_autotoc_md4}{}\doxysection{Documentation}\label{index_autotoc_md4}
...
Manual documentation can be found in docs folder.\hypertarget{index_autotoc_md5}{}\doxysection{Performance}\label{index_autotoc_md5}
...
This repository uses continous benchmarking\+: every commit and pull request measured and diff per each benchmark provided. Graphs over benchmark results can be found \href{https://victimsnino.github.io/ReactivePlusPlus/benchmark}{\texttt{ here}}\hypertarget{index_autotoc_md6}{}\doxysection{Credits\+:}\label{index_autotoc_md6}
