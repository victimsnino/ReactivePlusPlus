...
Reactive\+Plus\+Plus is reactuve programming library for C++ language inspired by \char`\"{}official implementation\char`\"{} (\href{https://github.com/ReactiveX/RxCpp}{\texttt{ Rx\+Cpp}}) and original idea (\href{https://reactivex.io/}{\texttt{ ReactiveX}})
