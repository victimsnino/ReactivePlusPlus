...
//     auto operator|(const auto& o) const{
//         return o(*this);
//     }
// };
...
//   auto operator()(const auto &v){return v;};
// };
// }
...
//   {
//     Obs obs{};
//     // obs.op(rpp::operators::map)();
//     obs | rpp::operators::filter([](const auto &v) { return v; })
//         | rpp::operators::filter([](const auto &v) { return v; })
//   }
  ...
  //         }
  //     }
  //     WHEN("subscribe on it, unsubscribe on first on next and dispatch till
  //     not empty")
  //     {
  ...
  //     run_loop); WHEN("subscribe on it and dispatch once")
  //     {
  //         obs.subscribe(mock);
  //         run_loop.dispatch();
