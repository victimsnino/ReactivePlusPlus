...
public:
    ...
    auto get_observer(rpp::composite_disposable_wrapper d) const {return rpp::observer<Type, rpp::details::with_external_disposasble<mock_observer_strategy<Type>>>{std::move(d), *this}; }
