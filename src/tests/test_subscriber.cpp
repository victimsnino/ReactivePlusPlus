...
{
    {
        [[maybe_unused]] auto temp_1 = rpp::dynamic_subscriber{[](int       ) {}};
        [[maybe_unused]] auto temp_2 = rpp::dynamic_subscriber{[](const int&) {}, [](std::exception_ptr) {}};
        [[maybe_unused]] auto temp_3 = rpp::dynamic_subscriber{[](const int&) {}, [](std::exception_ptr) {}, []() {}};
        [[maybe_unused]] auto temp_4 = rpp::dynamic_subscriber{[](const int&) {}, []() {}};
    }

    {
        [[maybe_unused]] auto temp_1 = rpp::specific_subscriber{[](int       ) {}};
        [[maybe_unused]] auto temp_2 = rpp::specific_subscriber{[](const int&) {}, [](std::exception_ptr) {}};
        [[maybe_unused]] auto temp_3 = rpp::specific_subscriber{[](const int&) {}, [](std::exception_ptr) {}, []() {}};
        [[maybe_unused]] auto temp_4 = rpp::specific_subscriber{[](const int&) {}, []() {}};
    }
}
