...
public:
    ...
    auto get_observer(rpp::composite_disposable_wrapper d) const { return rpp::observer_with_external_disposable<Type, mock_observer_strategy<Type>>{std::move(d), *this}; }
