...
int main() // NOLINT(bugprone-exception-escape)
{
    ...
    | rpp::operators::subscribe([start](int v) {
        std::cout << "received " << v << " at " << std::chrono::duration_cast<std::chrono::milliseconds>(rpp::schedulers::clock_type::now() - start).count() << std::endl;
    },
