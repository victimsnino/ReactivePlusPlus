...
\item 
struct \mbox{\hyperlink{structrpp_1_1schedulers_1_1current__thread_1_1is__queue__is__empty}{is\+\_\+queue\+\_\+is\+\_\+empty}}
\item 
...
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classrpp_1_1schedulers_1_1current__thread_a4992c66abcf309c1109bfc926db68451}\label{classrpp_1_1schedulers_1_1current__thread_a4992c66abcf309c1109bfc926db68451} 
static \mbox{\hyperlink{classrpp_1_1schedulers_1_1details_1_1schedulables__queue}{details\+::schedulables\+\_\+queue}}$<$ \mbox{\hyperlink{classrpp_1_1schedulers_1_1current__thread_1_1worker__strategy}{worker\+\_\+strategy}} $>$ \texorpdfstring{$\ast$}{*}\& {\bfseries get\+\_\+queue} ()
\item 
\Hypertarget{classrpp_1_1schedulers_1_1current__thread_a59ed77f7233d67c276bbe4b88c99e3ee}\label{classrpp_1_1schedulers_1_1current__thread_a59ed77f7233d67c276bbe4b88c99e3ee} 
static void {\bfseries drain\+\_\+queue} () noexcept
\item 
\Hypertarget{classrpp_1_1schedulers_1_1current__thread_a5d02bf8c0965a79046c42e07ef457a02}\label{classrpp_1_1schedulers_1_1current__thread_a5d02bf8c0965a79046c42e07ef457a02} 
static own\+\_\+queue\+\_\+guard {\bfseries own\+\_\+queue\+\_\+and\+\_\+drain\+\_\+finally\+\_\+if\+\_\+not\+\_\+owned} ()
\item 
...
\DoxyCodeLine{worker.schedule([\&worker](\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ handler)}
\DoxyCodeLine{\{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ rpp::schedulers::optional\_delay\_from\_now\{\};}
...
To have any visible impact you need to use it at least {\bfseries{twice}} during same observable. For example, {\ttfamily \doxylink{group__creational__operators_ga1edf47f176050dd414e28a1c0616b7c0}{rpp\+::source\+::just}} source uses it as default scheduler as well as {\ttfamily \doxylink{group__combining__operators_ga3f8a04b4c8eb945534eddde5a25eec74}{rpp\+::operators\+::merge}} operator (which just "{}owns"{} it during subscription).
\end{DoxyParagraph}
For example, this one 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__creational__operators_ga1edf47f176050dd414e28a1c0616b7c0}{rpp::source::just}}(1,\ 2,\ 3)}
\DoxyCodeLine{\ |\ \mbox{\hyperlink{group__combining__operators_ga35392a84e52bf7101d0d0445ef391db7}{rpp::operators::merge\_with}}(\mbox{\hyperlink{group__creational__operators_ga1edf47f176050dd414e28a1c0616b7c0}{rpp::source::just}}(4,\ 5,\ 6))}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__creational__operators_ga1edf47f176050dd414e28a1c0616b7c0}{rpp::source::just}}(\mbox{\hyperlink{classrpp_1_1schedulers_1_1immediate}{rpp::schedulers::immediate}}\{\},\ 1,\ 2,\ 3)}
\DoxyCodeLine{\ |\ \mbox{\hyperlink{group__combining__operators_ga35392a84e52bf7101d0d0445ef391db7}{rpp::operators::merge\_with}}(\mbox{\hyperlink{group__creational__operators_ga1edf47f176050dd414e28a1c0616b7c0}{rpp::source::just}}(\mbox{\hyperlink{classrpp_1_1schedulers_1_1immediate}{rpp::schedulers::immediate}}\{\},\ 4,\ 5,\ 6))}
\DoxyCodeLine{\ |\ \mbox{\hyperlink{group__utility__operators_ga149309d4b2e0f1201f1ab42597ace8ac}{rpp::operators::subscribe}}([](\textcolor{keywordtype}{int}\ v)\ \{\ std::cout\ <<\ v\ <<\ \textcolor{stringliteral}{"{}\ "{}};\ \});}

\end{DoxyCode}
 With output {\ttfamily 1 2 3 4 5 6} \begin{Desc}
\item[Examples]\par
\mbox{\hyperlink{combine_latest_8cpp-example}{combine\+\_\+latest.\+cpp}}, \mbox{\hyperlink{debounce_8cpp-example}{debounce.\+cpp}}, \mbox{\hyperlink{from_8cpp-example}{from.\+cpp}}, \mbox{\hyperlink{just_8cpp-example}{just.\+cpp}}, \mbox{\hyperlink{retry_when_8cpp-example}{retry\+\_\+when.\+cpp}}, \mbox{\hyperlink{take_until_8cpp-example}{take\+\_\+until.\+cpp}}, \mbox{\hyperlink{throttle_8cpp-example}{throttle.\+cpp}}, \mbox{\hyperlink{timeout_8cpp-example}{timeout.\+cpp}}, and \mbox{\hyperlink{window_toggle_8cpp-example}{window\+\_\+toggle.\+cpp}}.\end{Desc}
