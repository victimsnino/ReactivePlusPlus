...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{group__creational__operators_gab6cfd9da2e3590fd199c9972477e04df}{rpp::source::create<FinalType>}}([observable,\ fn](\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ observer)}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ observable.\mbox{\hyperlink{classrpp_1_1observable_a193b0e08c516912c04afd8379ec27182}{subscribe}}([observer,\ fn](\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ v)\ \{\ observer.on\_next(fn(v));\ \},}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ [observer](\textcolor{keyword}{const}\ std::exception\_ptr\&\ err)\ \{\ observer.on\_error(err);\ \},}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ [observer]()\ \{\ observer.on\_completed();\ \});}
\DoxyCodeLine{\ \ \ \ \};);}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{\}}
...
It is template for such an functor-\/adaptor. It is actually valid except of the one thing\+: observer is not copyable by default and we need to handle it, for example, call {\ttfamily as\+\_\+dynamic()} or to place in some shared\+\_\+ptr, but it is out of current explanation.
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ lift(\mbox{\hyperlink{conceptrpp_1_1constraint_1_1observer__of__type}{rpp::constraint::observer\_of\_type<Downstream>}}\ \textcolor{keyword}{auto}\&\&\ observer)\textcolor{keyword}{\ const}}
\DoxyCodeLine{\textcolor{keyword}{\ \ }\{}
\DoxyCodeLine{\ \ \ \ \ \ \textcolor{keywordflow}{return}\ rpp::make\_lambda\_observer<Upstream>([observer,\ fn](\textcolor{keyword}{const}\ \textcolor{keyword}{auto}\&\ v)\{\ observer.on\_next(fn(v));\ \},}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ [observer](\textcolor{keyword}{const}\ std::exception\_ptr\&\ err)\ \{\ observer.on\_error(err);\ \},}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ [observer]()\ \{\ observer.on\_completed();\ \});}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{\}}
...
\DoxyCodeLine{|\ rpp::operators::subscribe([](\textcolor{keyword}{auto})\{\});\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ 3}}
...
\DoxyCodeLine{|\ rpp::operators::subscribe([](\textcolor{keyword}{auto})\{\});}
...
\DoxyCodeLine{\ \ \ \ \ \ observer.on\_next(v);}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\ \ \})}
\DoxyCodeLine{\}).subscribe(...);}
