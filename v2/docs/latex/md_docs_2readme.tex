...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{group__creational__operators_gab6cfd9da2e3590fd199c9972477e04df}{rpp::source::create<FinalType>}}([observable,\ fn](\textcolor{keyword}{const}\ \mbox{\hyperlink{classrpp_1_1observer}{rpp::dynamic\_observer<FinalType>}}\&\ observer)}
\DoxyCodeLine{\ \ \ \ \{}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ lift(\textcolor{keyword}{const}\ \mbox{\hyperlink{classrpp_1_1observer}{rpp::dynamic\_observer<Downstream>}}\&\ observer)\textcolor{keyword}{\ const}}
