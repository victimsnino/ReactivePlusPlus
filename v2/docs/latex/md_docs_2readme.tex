...
As a a result, users can select preferable way of handling of their types.\hypertarget{md_docs_2readme_autotoc_md12}{}\doxysection{\texorpdfstring{Reactive\+Plus\+Plus specific}{Reactive\+Plus\+Plus specific}}\label{md_docs_2readme_autotoc_md12}
\hypertarget{md_docs_2readme_autotoc_md13}{}\doxysubsection{\texorpdfstring{dynamic\+\_\+\texorpdfstring{$\ast$}{*} versions to keep classes as variables}{dynamic\+\_\+\texorpdfstring{$\ast$}{*} versions to keep classes as variables}}\label{md_docs_2readme_autotoc_md13}
