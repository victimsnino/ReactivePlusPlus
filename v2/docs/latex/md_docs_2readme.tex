...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{return}\ rpp::source::create<FinalType>([observable,\ fn](\textcolor{keyword}{const}\ \mbox{\hyperlink{classrpp_1_1dynamic__observer}{rpp::dynamic\_observer<FinalType>}}\&\ observer)}
\DoxyCodeLine{\ \ \ \ \{}
